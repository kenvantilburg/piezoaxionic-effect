...
vec_L_1 = [L_1_fid * np.logspace(-3,2,int(1e4)), L_1_fid * np.logspace(0.0,4,int(1e4))]
...
for i,L_1 in enumerate(tqdm(vec_L_1_branch)):
    ...
    if i < N_shots//2:
        C_1 = vec_C_1[0]
        #L_2 = L2_find(T, l,v,a,b,h_11,c_11,beta_11,k2,L_squid, R_squid, L_i, k_i, C_1, L_1_n, k_f, eta, S_flux_squid, T_2, mu_N, n_N, xi_11, zeta_11, P_nuc, N_series,N_parallel,0, L_2)[0]
    else:
        C_1 = vec_C_1[1]
        #L_2 = L2_find(T, l,v,a,b,h_11,c_11,beta_11,k2,L_squid, R_squid, L_i, k_i, C_1, L_1_n, k_f, eta, S_flux_squid, T_2, mu_N, n_N, xi_11, zeta_11, P_nuc, N_series,N_parallel,1, L_2)[0]
